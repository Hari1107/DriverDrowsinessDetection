...
def startMonitoring():
    ...
    svm_predictor_path = r'D:¥Ragul¥driverdrowsiness¥driver¥DriverDrowsiness¥SVMclassifier.dat'
    EYE_AR_THRESH = 0.25
    ...
    while True:
        ...
        for rect in rects:
            ...
            if mouEAR > MOU_AR_THRESH:
                playsound.playsound(r"D:¥Ragul¥driverdrowsiness¥driver¥DriverDrowsiness¥alarm.wav")
...
font = ('times', 16, 'bold')
title = Label(main, text='Driver Drowsiness Monitoring System using Visual¥n'
